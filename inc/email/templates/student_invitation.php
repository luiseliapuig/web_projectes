...
function emailStudentInvitation(string $nombre, string $url, int $horas): array
{
    ...
    $html = '<!doctype html><html lang="ca"><head><meta charset="utf-8"></head>'
        ...
        . '<h1 style="margin:12px 0 0;font-size:27px;line-height:1.25;color:#172033">Accedeix a la web de projectes</h1></td></tr>'
        ...
        . '<p style="margin:0 0 24px">El professorat t’ha incorporat a la web de projectes. Crea la teva contrasenya personal per accedir-hi.</p>'
