...
function emailMemoriaApartatRevisioSolicitada(
    string $tutor,
    string $alumnat,
    string $projecte,
    string $apartat,
    ...
    $html = '<!doctype html><html lang="ca"><head><meta charset="utf-8"></head>'
        ...
        . '<p style="margin:0 0 24px"><strong style="color:#172033">' . $alumnatSegur . '</strong> ha sol·licitat la revisió de l’apartat <strong style="color:#172033">' . $apartatSegur . '</strong> de la Memòria del projecte <strong style="color:#172033">' . $projecteSegur . '</strong>.</p>'
        . '<table role="presentation" cellspacing="0" cellpadding="0"><tr><td style="border-radius:8px;background:#970A2C">'
        . '<a href="' . $urlSegura . '" style="display:inline-block;padding:13px 22px;color:#ffffff;text-decoration:none;font-weight:700">Revisar l’apartat de Memòria</a>'
        . '</td></tr></table>'
        . '<p style="margin:24px 0 0;font-size:14px;color:#687386">Pots consultar la memòria compartida i registrar el resultat de la revisió des d’aquesta pantalla.</p>'
    ...
    $text = "Hola {$tutor},\n\n"
        . "{$alumnat} ha sol·licitat la revisió de l’apartat {$apartat} de la Memòria del projecte {$projecte}.\n\n"
        . "Revisa'l aquí: {$url}\n\n"
        . "Pots consultar la memòria compartida i registrar el resultat de la revisió des d’aquesta pantalla.";
