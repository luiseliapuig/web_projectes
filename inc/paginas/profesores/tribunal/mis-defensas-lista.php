...
GROUP BY
    ...
    c.abr, g.grupo, p.curso_academico, p.defensa_fecha, p.defensa_aula_id,
...
<div class="panel-entregues tutored-projects-list">
    ...
    <div class="projectes-header tutored-projects-header d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4 mt-30">
        ...
        <nav class="view-switch" aria-label="Mode de visualització">
            <a href="/les-meves-defenses" class="view-switch-option">Fitxes</a>
            <a href="/les-meves-defenses/llista" class="view-switch-option active" aria-current="page">Llistat</a>
        </nav>
    </div>
