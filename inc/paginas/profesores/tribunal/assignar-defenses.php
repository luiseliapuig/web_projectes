...
// El calendari només està disponible per al professorat mentre la selecció
// estiga oberta; el superadministrador conserva l'accés per a supervisar-la.
if (
    !esProfesor()
    || (!configuracion('seleccionar_defensas') && !esSuperadmin())
) {
...
<script>window.PAGE_TITLE = 'Assignar defenses';</script>
<section class="container-fluid">

    <div class="d-flex flex-wrap align-items-center gap-3 mb-4 mt-30">
        <div>
            <h1 class="projectes-title mb-2">Assignar defenses</h1>
            <p class="projectes-subtitle mb-0">Apunta't als tribunals de defensa. Màxim 3 membres per projecte.</p>
        </div>
    </div>
...
const URL_DADES = '/index.php?main=assignar-defenses-dades';
const URL_ACCIO = '/index.php?main=assignar-defenses-accio';
const CSRF_TOKEN = <?= json_encode(tokenCsrf(), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
