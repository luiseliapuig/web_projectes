...
// El alumno solo puede editar el proyecto vinculado a su sesión.
if (!configuracion('permitir_editar') || !esSuProyectoAlumno($idProyecto)) {
...
try {
    ...
    SELECT
        ...
        COALESCE((
            ...
            FROM rel_proyectos_profesores rpp
            INNER JOIN profesores pr ON pr.id_profesor = rpp.profesor_id
        ...
        COALESCE((
            ...
            FROM rel_proyectos_profesores rpp
            INNER JOIN profesores pr ON pr.id_profesor = rpp.profesor_id
            WHERE rpp.proyecto_id = p.id_proyecto AND rpp.rol = 'cotutor'
        ), '') AS cotutors_nom
    FROM proyectos p
...
<div class="container-fluid">
  ...
  <?php // mostrar fecha de defensas a los alumnos interesados y a cualquier profesor si se deciden mostrar
        if (
            ...
            include __DIR__ . '/../public/bloque-defensa.php';
...
<!-- fin caja de ayuda -->
            ...
            <form id="form-ficha-proyecto" action="/index.php?main=ficha_proyecto_accion" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="puig-panel-content">
                                        ...
                                        <div class="container-fluid px-4 ml-0 mr-0">
                                            ...
                                            <?php if ($nombreCotutor !== ''): ?>
                                                <div class="col">
                                                    <div class="mb-0">
                                                        <strong class="info-label">Cotutors:</strong><br>
                                                        <?= h($nombreCotutor) ?>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
...
const _adjuntUrl     = '/index.php?main=ficha_proyecto_adjunto_accion';
const _adjuntCsrf    = <?= json_encode(tokenCsrf()) ?>;
...
async function afegirArxiu() {
    ...
    fd.append('csrf_token', _adjuntCsrf);
